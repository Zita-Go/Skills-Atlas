...
Open `data/categories.yaml` to view the 20 categories / 117 subcategories, and find the closest fit.
...
## Changing the 20 categories / 117 subcategories structure
...
│   ├── categories.yaml      # 20 categories / 117 subgroups
│   ├── skills.yaml          # 319 skill groups
│   └── repositories.yaml    # metadata for 118 source repositories
